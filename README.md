...
uv run pytest -q                       # full offline suite (1637 tests, $0)
...
tests/                1637 offline tests ($0, no key)
...
```bash
uv run pytest -q                       # all 1637 offline tests
...
Integrations below),
generated by re-running the real gates, not by hand: the full offline suite (1637 tests, 0
